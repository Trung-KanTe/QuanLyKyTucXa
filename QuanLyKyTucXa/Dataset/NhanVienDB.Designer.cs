...
namespace QuanLyKyTucXa.Dataset {
    ...
    public partial class DBNhanVien : global::System.Data.DataSet {
        ...
        public partial class NHANVIENDataTable : global::System.Data.TypedTableBase<NHANVIENRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public NHANVIENRow AddNHANVIENRow(string MaNhanVien, long SDT, string TenNhanVien, string Email, string DiaChi, string ChucVu, string TinhTrang) {
...
namespace QuanLyKyTucXa.Dataset.DBNhanVienTableAdapters {
    ...
    public partial class NHANVIENTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[NHANVIEN] WHERE (([MaNhanVien] = @Original_MaNhanVien) AND ((@IsNull_SDT = 1 AND [SDT] IS NULL) OR ([SDT] = @Original_SDT)) AND ((@IsNull_TenNhanVien = 1 AND [TenNhanVien] IS NULL) OR ([TenNhanVien] = @Original_TenNhanVien)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_ChucVu = 1 AND [ChucVu] IS NULL) OR ([ChucVu] = @Original_ChucVu)) AND ((@IsNull_TinhTrang = 1 AND [TinhTrang] IS NULL) OR ([TinhTrang] = @Original_TinhTrang)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[NHANVIEN] ([MaNhanVien], [SDT], [TenNhanVien], [Email], [DiaChi], [ChucVu], [TinhTrang]) VALUES (@MaNhanVien, @SDT, @TenNhanVien, @Email, @DiaChi, @ChucVu, @TinhTrang);
SELECT MaNhanVien, SDT, TenNhanVien, Email, DiaChi, ChucVu, TinhTrang FROM NHANVIEN WHERE (MaNhanVien = @MaNhanVien)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[NHANVIEN] SET [MaNhanVien] = @MaNhanVien, [SDT] = @SDT, [TenNhanVien] = @TenNhanVien, [Email] = @Email, [DiaChi] = @DiaChi, [ChucVu] = @ChucVu, [TinhTrang] = @TinhTrang WHERE (([MaNhanVien] = @Original_MaNhanVien) AND ((@IsNull_SDT = 1 AND [SDT] IS NULL) OR ([SDT] = @Original_SDT)) AND ((@IsNull_TenNhanVien = 1 AND [TenNhanVien] IS NULL) OR ([TenNhanVien] = @Original_TenNhanVien)) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_DiaChi = 1 AND [DiaChi] IS NULL) OR ([DiaChi] = @Original_DiaChi)) AND ((@IsNull_ChucVu = 1 AND [ChucVu] IS NULL) OR ([ChucVu] = @Original_ChucVu)) AND ((@IsNull_TinhTrang = 1 AND [TinhTrang] IS NULL) OR ([TinhTrang] = @Original_TinhTrang)));
SELECT MaNhanVien, SDT, TenNhanVien, Email, DiaChi, ChucVu, TinhTrang FROM NHANVIEN WHERE (MaNhanVien = @MaNhanVien)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT MaNhanVien, SDT, TenNhanVien, Email, DiaChi, ChucVu, TinhTrang FROM dbo.NH" +
                "ANVIEN";
        ...
        public virtual int Delete(string Original_MaNhanVien, global::System.Nullable<long> Original_SDT, string Original_TenNhanVien, string Original_Email, string Original_DiaChi, string Original_ChucVu, string Original_TinhTrang) {
        ...
        public virtual int Insert(string MaNhanVien, global::System.Nullable<long> SDT, string TenNhanVien, string Email, string DiaChi, string ChucVu, string TinhTrang) {
            if ((MaNhanVien == null)) {
            ...
            if ((SDT.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[1].Value = ((long)(SDT.Value));
            }
            else {
        ...
        public virtual int Update(string MaNhanVien, global::System.Nullable<long> SDT, string TenNhanVien, string Email, string DiaChi, string ChucVu, string TinhTrang, string Original_MaNhanVien, global::System.Nullable<long> Original_SDT, string Original_TenNhanVien, string Original_Email, string Original_DiaChi, string Original_ChucVu, string Original_TinhTrang) {
            if ((MaNhanVien == null)) {
                throw new global::System.ArgumentNullException("MaNhanVien");
            }
            else {
            ...
            if ((SDT.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[1].Value = ((long)(SDT.Value));
            }
            else {
            ...
            if ((Original_SDT.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[9].Value = ((long)(Original_SDT.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(global::System.Nullable<long> SDT, string TenNhanVien, string Email, string DiaChi, string ChucVu, string TinhTrang, string Original_MaNhanVien, global::System.Nullable<long> Original_SDT, string Original_TenNhanVien, string Original_Email, string Original_DiaChi, string Original_ChucVu, string Original_TinhTrang) {
            return this.Update(Original_MaNhanVien, SDT, TenNhanVien, Email, DiaChi, ChucVu, TinhTrang, Original_MaNhanVien, Original_SDT, Original_TenNhanVien, Original_Email, Original_DiaChi, Original_ChucVu, Original_TinhTrang);
        }
    }
